...
import io.yMusic.compose.persist.PersistMap
import io.yMusic.compose.persist.PersistMapOwner
import io.yMusic.innertube.Innertube
import it.vfsfitvnm.innertube.models.bodies.BrowseBody
import io.yMusic.innertube.requests.playlistPage
import io.yMusic.innertube.requests.song
...
import io.yMusic.android.utils.forcePlay
                    ...
                    SharedPreferences.OnSharedPreferenceChangeListener { sharedPreferences, key ->
                        when (key) {
                            ...
                            useSystemFontKey, applyFontPaddingKey -> {
                                ...
                                val applyFontPadding = sharedPreferences.getBoolean(
                                    applyFontPaddingKey, false)
            ...
            when (val path = uri.pathSegments.firstOrNull()) {
                "playlist" -> uri.getQueryParameter("list")?.let { playlistId ->
                    ...
                    if (playlistId.startsWith("OLAK5uy_")) {
                        io.innertube.requests.playlistPage(BrowseBody(browseId = browseId))?.getOrNull()?.let {
